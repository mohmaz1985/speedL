...
<header>
    ...
    $menuItems = [
        ['label' => '<i class="fa fa-home"></i><br/>'.Yii::t('yii','Home'), 'url' => ['/site/index']],
        ['label' => '<i class="fa fa-info-circle"></i><br/>'.Yii::t('yii','About Us'), 'url' => ['#'],
         'items' => [
            ['label' => 'Action', 'url' => '#'],
        ...
        ['label' => '<i class="fa  fa-newspaper-o"></i><br/>'.Yii::t('yii','News'), 'url' => ['/site/news']],
        ['label' => '<i class="fa  fa-connectdevelop"></i><br/>'.Yii::t('yii','Services'), 'url' => ['/site/services']],
        ['label' => '<i class="fa  fa-users"></i><br/>'.Yii::t('yii','Tech Partners'), 'url' => ['/site/partners']],
        ['label' => '<i class="fa  fa-phone"></i><br/>'.Yii::t('yii','Contact Us'), 'url' => ['/site/contact']],
        // ['label' => "<span class='language' id='".$languageID."' ><i class='fa  fa-share-square-o'></i><br/>".Yii::t('yii','العربية')."</span>"],

    ];
    echo Nav::widget([
        'options' => ['class' => 'nav navbar-nav '.$navBarDirection],
        'encodeLabels' => false,

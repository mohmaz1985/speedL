...
class ServicesSearch extends Services
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'services.title', $this->title])
            ->andFilterWhere(['like', 'services.description', $this->description])
            ->andFilterWhere(['like', 'services.image', $this->image])
            ->andFilterWhere(['like', 'categories.title', $this->categories])
            ->andFilterWhere(['=', 'services.lang', Yii::$app->language])
            ->andFilterWhere(['=', 'services.status', 1 ]);
        return $dataProvider;
    }
}

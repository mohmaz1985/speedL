 ...
 * @property string $showInHeader
 * @property string $showInHomePage
...
class Services extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['description'], 'string'],
            [['status','showInHeader','showInHomePage','showInSubMenu','publish','order_recorder','old_order_recorder','created_at', 'created_by', 'updated_at', 'updated_by'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'showInHeader' => Yii::t('yii','Show in header'),
            'showInHomePage'=>Yii::t('yii','Show in home page'),
            'showInSubMenu'=>Yii::t('yii','Show in Sub Menu'),
